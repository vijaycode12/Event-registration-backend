...
export const signUp = async(req,res,next) =>{
    ...
    try{
        ...
        //req.body is an object taking data from client(POST request(create))
        ...
        //Checking if the user is persent or not
        ...
        //If user does not exists then we need to hash the password using bcryptjs
...
export const logIn = async(req,res,next)=>{
    try{
        ...
        res.cookie('token', token, {
            ...
            sameSite:'none', // exactly this string
